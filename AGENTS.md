...
2. Read the relevant Tier 1 architecture document.
3. Read the affected Tier 2 subsystem README.
4. Read the relevant Tier 3 module documents.
5. Check the source files and update stale documentation before writing the spec.

For a feature or larger change, create a grounded spec under
`specs/features/<feature-name>.md` before changing code. The spec must include
current behavior, proposed behavior, acceptance criteria, files to change,
tests, risks and open questions.
